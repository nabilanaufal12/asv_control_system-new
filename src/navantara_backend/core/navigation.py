...
# [FIX YEL-07] Fungsi orphan (haversine_distance, get_bearing_to_point,
# run_navigation_logic) telah dihapus karena navigasi waypoint sekarang
# diproses langsung oleh ESP32. Hanya PIDController yang dipertahankan.
