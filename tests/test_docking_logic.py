...
class TestDockingLogic(unittest.TestCase):
    def setUp(self):
        ...
        with patch('navantara_backend.core.asv_handler.SerialHandler') as MockSerial, \
             patch('navantara_backend.core.asv_handler.MissionLogger') as MockLogger:
    ...
    def test_1_config_read_write(self):
        ...
        self.assertEqual(self.handler.config["docking_mission"]["Arena_A"]["duration_sec"], 25)
